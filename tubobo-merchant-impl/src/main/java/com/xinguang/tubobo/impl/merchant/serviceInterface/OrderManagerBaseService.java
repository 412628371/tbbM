...
package com.xinguang.tubobo.impl.merchant.serviceInterface;
...
public abstract class OrderManagerBaseService {
    ...
    @Autowired
    private RmqTakeoutAnswerProducer rmqTakeoutAnswerProducer;
    @Resource
    ...
    @Autowired
    private TbbOrderServiceInterface launcherInnerTbbOrderService;
